...
public class PathTracer : MonoBehaviour
{
    ...
    public void SetUniformGrid()
    {
        ...
        path_tracing_CS.SetBuffer(path_tracing_kernel, "MatBuffer", AccelerationStructures.MatBuffer);
        path_tracing_CS.SetBuffer(path_tracing_kernel, "MatIdxBuffer", AccelerationStructures.MatIdxBuffer);
